 ...
 * @mixin \Eloquent
 */
class PublicTrxProposalMitra extends Model
{
    use Uuid;

    protected $table            = 'public.trx_proposal_mitra';
    private static $tableName   = 'public.trx_proposal_mitra';
    protected $primaryKey       = 'trx_proposal_mitra_id'; 
