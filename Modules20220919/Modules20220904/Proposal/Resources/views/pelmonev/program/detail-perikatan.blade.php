                    ...
                    <div class="col-md-12">
                        <table class="table" width="50%">
                            ...
                            <tr>
                                ...
                                <td>: </td>
                                <td>{{ $total != '' ? "Rp " . number_format($total->nominal_rekomendasi,2,',','.') : 0 }}</td>
                            </tr>
                            <tr>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group form-group-float">
                                        ...
                                        <input type="text" name="nomor_pks_mitra" class="form-control" value="{{ $trxpks ? $trxpks->no_pks_mitra : '' }}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group form-group-float">
                                        ...
                                        <textarea name="alamat_bpkh" class="form-control" aria-valuemax="{{ $trxpks ? $trxpks->no_pks_bpkh : 'Menara Bidakara 1, lantai 5 dan 8, Jl. Gatot Subroto, RT.1/RW.1, Menteng Dalam, Kec. Pancoran, Kota Jakarta Selatan, Daerah Khusus Ibukota Jakarta 12870' }}">{{ $trxpks ? $trxpks->no_pks_bpkh : 'Menara Bidakara 1, lantai 5 dan 8, Jl. Gatot Subroto, RT.1/RW.1, Menteng Dalam, Kec. Pancoran, Kota Jakarta Selatan, Daerah Khusus Ibukota Jakarta 12870' }}</textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group form-group-float">
                                        ...
                                        <input type="text" name="kepala_bpkh" class="form-control" value="{{ $trxpks ? $trxpks->kepala_bpk : '' }}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group form-group-float">
                                        ...
                                        <input type="text" name="sk_peng_kep_bpkh" class="form-control" value="{{ $trxpks ? $trxpks->sk_pengangkatan_kep_bpkh : '' }}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group form-group-float">
                                        ...
                                        <textarea name="alamat_mitra" class="form-control" value="{{ $trxpks ? $trxpks->alamat_mitra : '' }}">{{ $trxpks ? $trxpks->alamat_mitra : '' }}</textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group form-group-float">
                                        <label class="form-group-float-label is-visible">SK Pendirian Mitra Kemaslhatan<span class="text-danger">*</span></label>
                                        <input type="text" name="sk_pendirian_mitra" class="form-control" value="{{ $trxpks ? $trxpks->sk_pendirian_mitra : '' }}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group form-group-float">
                                        ...
                                        <select name="termin" class="form-control termin">
                                ...
                                <div class="col-md-6 termin-sekaligus" style="display: none;">
                                    <div class="form-group form-group-float">
                                        ...
                                        <input type="text" class="form-control" name="termin_value_sekaligus" placeholder="mohon isi termin">
                                    </div>
                                </div>
                                <div class="col-md-6 termin-2" style="display: none;">
                                    <div class="form-group form-group-float">
                                        <label class="form-group-float-label is-visible">2 Termin<span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" name="termin_value_2[]" placeholder="mohon isi termin 1">
                                        <input type="text" class="form-control" name="termin_value_2[]" placeholder="mohon isi termin 2">
                                    </div>
                                </div>
                                <div class="col-md-6 termin-3" style="display: none;">
                                    <div class="form-group form-group-float">
                                        ...
                                        <input type="text" class="form-control" name="termin_value_3[]" placeholder="mohon isi termin 1">
                                        <input type="text" class="form-control" name="termin_value_3[]" placeholder="mohon isi termin 2">
                                        <input type="text" class="form-control" name="termin_value_3[]" placeholder="mohon isi termin 3">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group form-group-float">
                                        ...
                                        <input type="date" name="start_date_timeline" class="form-control" value="{{ $trxpks ? $trxpks->start_date_timeline : '' }}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group form-group-float">
                                        <label class="form-group-float-label is-visible">Timeline Kontrak (End Date)<span class="text-danger">*</span></label>
                                        <input type="date" name="end_date_timeline" class="form-control" value="{{ $trxpks ? $trxpks->end_date_timeline : '' }}">
                                    </div>
                                </div> 
                            </div>
                            <div class="row">
