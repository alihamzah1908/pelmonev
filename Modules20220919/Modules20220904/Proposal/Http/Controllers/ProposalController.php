...
class ProposalController extends Controller
{
	...
	$analisisResiko = PublicTrxProposalAnalisisResiko::where('trx_proposal_id', $proposal->trx_proposal_child_id)->first();
        ...
        return view('proposal::' . $this->folder_path . '.' . $filename_page, compact('proposal','analisKepatuhan', 'penilaianMitra', 'analisisHk', 'pemohon', 'title', 'deskripsi', 'mitra', 'analisa', 'banks', 'pelaksanaanPenilaian', 'analisisHk', 'proposalmitra','analisisResiko'));
    }
