...
class KeputusanRBPController extends Controller
{
    private $folder_path = '';
    ...
    function index($id = NULL){
        $baseUrl        = 'keputusan-rbp';
        
        if ($id) {
            $filename_page 	= 'detail';
            $title 			= 'Detail Keputusan Rapat BP';
            ...
            $filename_page 	= 'list-proposal-rbp';
            $title 		= 'Keputusan Rapat BP';
