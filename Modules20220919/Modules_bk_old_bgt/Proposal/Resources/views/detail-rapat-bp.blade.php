...
<div class="card">
        <div class="card-header">
            <h6 class="card-title">
                <a class="collapsed text-default" data-toggle="collapse" href="#analisa-kepatuhan">Analisa Kepatuhan</a>
            </h6>
        </div>
        <div class="card-body">
	  <div id="analisa-kepatuhan" class="collapse" data-parent="#accordion-default">
        ...
        tabelPenilaian = $('#tabel-penilaian-hasil').DataTable({
            ...
            ajax		: {
                ...
                data: function(data){
                    ...
                    data.id     =  "{{ $proposalmitra->trx_proposal_mitra_id }}";
                },
            },
            dom : 'tpi',
            columns: [
