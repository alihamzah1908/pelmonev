...
<div class="row">
    ...
    <div class="col-md-3">
        <div class="card card-body border-top-1 border-top-teal">
            <button type="button" class="btn btn-block btn-primary mb-2" data-bind="{{ $proposal->trx_proposal_id }}" id="disposisi-proposal">{{ substr($status->trx_proses_status_id,7,strlen($status->trx_proses_status_id)).' - '.$status->proses_nm }} <i class="icon-merge ml-2"></i></button>
        </div>
    </div>
</div>
