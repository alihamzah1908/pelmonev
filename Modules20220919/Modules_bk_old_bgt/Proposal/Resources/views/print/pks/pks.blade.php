        ...
        <div class="halaman">	
			<div class="tanda-tangan">
				<table width="100%" style="font-size: 12" style="border: none">
					<tr>
						<td style="width: 50%;">
                			<img align="top" src="data:image/png;base64, {{ base64_encode(file_get_contents(public_path('images/logo-bpkh-s.png'))) }}" width="250px">
						</td>
						<td style="width: 50%;">
                			{{-- <img align="top" src="data:image/png;base64, {{ base64_encode(file_get_contents(public_path('images/logo-bpkh-s.png'))) }}" width="250px"> --}}
						</td>
            ...
            <table class="tabel-sk" width="100%" style="table-layout:fixed; margin-top: 0px;vertical-align: top;text-align: justify;letter-spacing: 0px;line-height: 1.5rem; word-break:break-all; word-wrap:break-word;">
				...
				<tr>
					...
					<td style="vertical-align: top;" width="20cm" style="font-size: 11pt;font-family:Arial, Helvetica, sans-serif">
						...
						berkedudukan dan berkantor di Menara Bidakara 1 Lantai 8, Jl. Gatot Subroto Kav. 71-73, Pancoran, Jakarta Selatan 12870, 
						dalam hal ini diwakili oleh Dr Anggito Abimanyu, MSc. 
						Dalam jabatannya selaku Kepala Badan Pelaksana Badan Pengelola Keuangan Haji berdasarkan 
						Keputusan Presiden RI Nomor 127/P Tahun 2018 tentang Pengangkatan Kepala Badan Pelaksana BPKH tertanggal 6 Agustus 2018, 
				...
				<tr style="">
					...
					<td style="vertical-align: top" width="98%" style="font-size: 11pt;font-family:Arial, Helvetica, sans-serif">
						...
						berkedudukan dan berkantor di {{ $data->address }}, 
						dalam hal ini diwakili oleh {{ $data->penanggung_jawab_nm }}. 
						Dalam jabatannya selaku {{ $data->penanggung_jawab_jabatan }} 
						berdasarkan {{ $data->akta_pendirian }}, 
						dari dan oleh karenanya sah bertindak untuk dan atas nama {{ $data->mitra_kemaslahatan_nm }}, 
				...
				<tr>
					<td width="100%" style="" colspan="2">
						<br>
						<b>PIHAK PERTAMA</b> dan <b>PIHAK KEDUA</b> secara bersama-sama untuk selanjutnya disebut sebagai <b>"Para Pihak"</b>, 
				...
				<tr>
					<td style="vertical-align: top;" width="1%">2.</td>
					<td style="vertical-align: top;" width="99%" style="font-size: 11pt;font-family:Arial, Helvetica, sans-serif">
						Pelaksanaan Kegiatan sebagaimana dimaksud pada ayat 1 dilakukan sesuai dengan Proposal yang telah disetujui oleh PIHAK PERTAMA melalui Keputusan Kepala Badan Pelaksana Nomor 018/BPKH.00/02/2022 Tanggal 2 Februari 2022.
					</td>
                </tr>
				...
				<tr>
					<td style="vertical-align: top;" width="1%">1.</td>
					<td style="vertical-align: top;" width="99%" style="font-size: 11pt;font-family:Arial, Helvetica, sans-serif">
						Perjanjian ini mulai berlaku sejak tanggal ditandatangani, sampai dengan PIHAK PERTAMA telah menyetujui laporan pertanggungjawaban akhir dari PIHAK KEDUA, selambat-lambatnya pada tanggal 30 April 2022.
					</td>
                </tr>
				<tr>
					<td style="vertical-align: top;" width="1%">2.</td>
