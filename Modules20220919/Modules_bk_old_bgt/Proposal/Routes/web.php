...
|
*/
Route::group(['prefix' => 'proposal','middleware' => ['check.role.menu:PROPOSAL','verified']], function () {
    ...
    Route::get('/rapatbp/{id}/show', 'ProposalController@showrapatbp');
    Route::get('/rapatkek', 'ProposalController@viewbp');
    Route::get('/rapatkek/{id}/show', 'ProposalController@showrapatbp');
