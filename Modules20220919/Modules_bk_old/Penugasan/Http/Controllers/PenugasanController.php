...
class PenugasanController extends Controller
{
    ...
    function index($id = NULL){
        ...
        if ($id) {
            ...
            return view('penugasan::' . $this->folder_path . '.' . $filename_page, compact('title', 'proposal', 'pemohon','userPemohon','banks','disposisi','lastStatus', 'status'));
        }else{
            $filename_page 	= 'index';
            $title 			= 'Penugasan BPKH';
            ...
            return view('penugasan::' . $this->folder_path . '.' . $filename_page, compact('title'));
        }
    }
    ...
    function getData(Request $request){
        ...
        return DataTables::of($data)
            ...
            ->addColumn('date_picker', function($data) use($currUserData){
                return "<input type='date' class='form-control' data-placement='top'>";
