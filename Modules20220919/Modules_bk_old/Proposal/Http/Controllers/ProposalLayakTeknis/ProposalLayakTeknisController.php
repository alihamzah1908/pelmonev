...
class ProposalLayakTeknisController extends Controller
{
    private $folder_path = 'layak-teknis';
    private $prosesSt   = 'PROSES_14';
    ...
    function index($id = NULL){
        if ($id) {
            ...
            return view('proposal::' . $this->folder_path . '.' . $filename_page, compact('title', 'proposal', 'pemohon','userPemohon','banks','disposisi','lastStatus', 'status', 'analisa', 'deskripsi', 'mitra','pelaksanaanPenilaian'));
        }else{
            $filename_page 	= 'index';
            $title 			= 'Proposal';
