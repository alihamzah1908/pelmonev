...
class ProposalController extends Controller
{
	...
	//dd($analisa);
        ...
        return view('proposal::' . $this->folder_path . '.' . $filename_page, compact('proposal', 'analisisHk', 'pemohon', 'title', 'deskripsi', 'mitra', 'analisa', 'banks', 'pelaksanaanPenilaian', 'analisisHk'));
    }
