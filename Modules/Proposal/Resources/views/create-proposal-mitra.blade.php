...
<div class="row">
                ...
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="tab-data-proposal">
                        <form class="form-validate-jquery form-proposal" id="form-proposal" action="#">
                            ...
                            <input type="hidden" name="trx_pemohon_id" value="{{ $proposal != '' ? $proposal->trx_pemohon_id : '' }}">
                            <input type="hidden" name="trx_mitra_kemaslahatan_id" value="{{ $proposal != '' ? $proposal->trx_mitra_kemaslahatan_id : '' }}">
                            <input type="hidden" name="trx_mitra_strategis_id" value="{{ $proposal != '' ? $proposal->trx_mitra_strategis_id : '' }}">
                            <input type="hidden" name="proposal_no" value="{{ $proposal != '' ? $proposal->proposal_no : '' }}">
                            <input type="hidden" name="trx_proposal_id" value="{{ $proposal != '' ? $proposal->trx_proposal_id : '' }}">
                            <div class="row">
                                <div class="col-md-12">
                            ...
                            <div class="row">
                                ...
                                <div class="d-flex justify-content-end align-items-center">
                                    ...
                                    <!-- <button type="button" class="btn btn-light ml-2 legitRipple" id="reset">Draft <i class="icon-reload-alt ml-2"></i></button> -->
                                </div>
                            </div>
                        </form>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group form-group-float">
                                        ...
                                        <input type="text" id="pemohon_nm" name="pemohon_nm" class="form-control" value="{{ $pemohon != '' ? $pemohon->pemohon_nm : '' }}" readonly="readonly" placeholder="Nama Pemohon" aria-invalid="false">
                                    </div>
                                    <div class="form-group form-group-float">
                                        <label class="form-group-float-label is-visible">Nomor Akta Pendirian</label>
                                        <input type="text" id="akta_pendirian" name="akta_pendirian" class="form-control" value="{{ $proposal != '' ? $proposal->akta_pendirian : '' }}" required="" placeholder="">
                                    </div>
                                    <div class="form-group form-group-float">
                                        <label class="form-group-float-label is-visible">Akta Perubahan Terakhir</label>
                                        <input type="text" id="akta_perubahan_terakhir" name="akta_perubahan_terakhir" class="form-control" placeholder="" value="{{ $proposal != '' ? $proposal->akta_perubahan_terakhir : ''}}" required="" aria-invalid="false">
                                    </div>
                                    <div class="form-group form-group-float">
                                        <label class="form-group-float-label is-visible">No SK Pengesahan Pendirian</label>
                                        <input type="text" id="sk_pengesahan_pendirian_no" name="sk_pengesahan_pendirian_no" class="form-control" placeholder="" value="{{  $proposal != '' ? $proposal->sk_pengesahan_pendirian_no : '' }}" required="" aria-invalid="false">
                                    </div>
                                    <div class="form-group form-group-float">
                                        <label class="form-group-float-label is-visible">No SK Pengesahan Perubahan Terakhir</label>
                                        <input type="text" id="sk_pengesahan_perubahan_terakhir_no" name="sk_pengesahan_perubahan_terakhir_no" class="form-control" placeholder="" value="{{ $proposal != '' ? $proposal->sk_pengesahan_perubahan_terakhir_no : '' }}" required="" aria-invalid="false">
                                    </div>
                                    <div class="form-group form-group-float">
                                        <label class="form-group-float-label is-visible">No KTP Pimpinan</label>
                                        <input type="text" id="ktp_no_pimpinan" name="ktp_no_pimpinan" class="form-control" placeholder="" value="{{ $proposal != '' ? $proposal->ktp_no_pimpinan : '' }}" required="" aria-invalid="false">
                                    </div>
                                    <div class="form-group form-group-float">
                                        <label class="form-group-float-label is-visible">No NPWP Lembaga</label>
                                        <input type="text" id="npwp_no_lembaga" name="npwp_no_lembaga" class="form-control" placeholder="" value="{{ $proposal != '' ? $proposal->npwp_no_lembaga : '' }}" required="" aria-invalid="false">
                                    </div>
                                </div>
                            </div>
                           @if ($proposal->sent_st == '0')    
				    ...
				    <input type="hidden" name="kategori_rab" id="kategori_rab_pengadaan" value="pengadaan">
                                    <input type="hidden" name="proposal_id" value="{{ $proposal != '' ? $proposal->trx_proposal_id : '' }}">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group form-group-float">
				    ...
				    <!--<div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group form-group-float">
                                                <label class="form-group-float-label is-visible">Biaya Rekomendasi BPKH <span class="text-danger">*</span></label>
                                                <input type="text" name="biaya_rekomendasi" class="form-control money form-child-field">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group form-group-float">
                                                <label class="form-group-float-label is-visible">Biaya Satuan Rekomendasi BPKH<span class="text-danger">*</span></label>
                                                <input type="text" name="satuan_rekomendasi" class="form-control money form-child-field">
                                            </div>
                                        </div>
                                    </div>
				    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group form-group-float">
                                                <label class="form-group-float-label is-visible">Upload Kewajaran<span class="text-danger">*</span></label>
                                                <input type="file" name="upload_kewajaran" class="form-control form-child-field">
                                            </div>
                                        </div>
                                    </div>--!>                                 
					@if ($proposal->sent_st == '0')    
    ...
    <div class="col-md-3">
        <div class="card card-body border-top-1 border-top-teal">
            <button type="button" class="btn btn-block btn-primary mb-2" data-bind="{{ $proposal->trx_proposal_id }}" data-status="PROSES_AMK" id="disposisi-proposal">{{ substr($status->trx_proses_status_id,7,strlen($status->trx_proses_status_id)).' - '.$status->proses_nm }} <i class="icon-merge ml-2"></i></button>
        </div>
    </div>
    @endif
</div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group form-group-float">
                                ...
                                <input type="file" name="proposal_file" id="proposal_file" class="form-control" required="" placeholder="" accept="application/pdf">
                            </div>
                        </div>
                    </div>
                </form>
...
<script>
    ...
    $(document).ready(function(){
        ...
        $('.form-proposal').submit(function(e){
			...
			//--Handle the invalid form
                ...
                @endif
                var url     = baseUrl + '/insert-proposal-mitra/' + dataCd;
                var method  = 'POST';
        ...
        $('.form-edit-rab').submit(function(e){
			...
			//--Handle the invalid form
                ...
                var record  = new FormData(this);
                var url     = baseUrl + '/rab/data/update/' +  dataCd;
                var method  = 'POST';
                var id      = $(this).attr('id');
        ...
        $('body').on('click', '#disposisi-proposal',function(){
            var trx_proposal_mitra_id = $(this).attr('data-bind')
            var prosess = $(this).attr('data-status')
            swal({
                        ...
                        'success': function(response){
                            if(response["status"] == 'ok') {
                                swal({
                                    ...
                                    window.location = baseUrl +'/list-proposal'
                                    swal.close();
                                });
                            }else{
                                swal({title: "Proses gagal",type: "error",showCancelButton: false,showConfirmButton: false,timer: 1000});
    ...
    $('#proposal_file').bind('change', function() {
        //this.files[0].size gets the size of your file.
	if(this.files[0].size > 2000000){
	   alert('Ukuran file terlalu besar, maximal file 2 MB')
	   $("#proposal_file").val('')
	}	
    });
