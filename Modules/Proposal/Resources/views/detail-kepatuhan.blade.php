...
<div id="accordion-default">
                    ...
                    <table class="table datatable-pagination" id="tabel-data" width="100%">
                        ...
                        <tbody style="vertical-align: top">
                            <tr>
                                ...
                                <td>
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" class="custom-control-input" name="verif_1_value" id="verif_1_ya" value="1" @if($analisKepatuhan) {{ $analisKepatuhan->verif_1_value == '1' ? 'checked' : '' }} @else checked='true' @endif">
                                ...
                                <td>
                                    <textarea name="verif_1_note" id="verif_1_note" class="form-control" placeholder="Penjelasan">@if($analisKepatuhan && $analisKepatuhan->verif_1_note) {{ $analisKepatuhan != '' ? $analisKepatuhan->verif_1_note : '' }} @else Kegiatan	kemaslahatan masuk dalam kategori yang ditentukan: Pelayanan Ibadah Haji, Pendidikan dan Dakwah, Kesehatan, Sosial Keagamaan, Ekonomi umat, Sarana dan Prasarana Ibadah @endif
			            </textarea>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" class="custom-control-input" name="verif_2_value" id="verif_2_ya" value="2" @if($analisKepatuhan) {{ $analisKepatuhan->verif_2_value == 2 ? 'checked' : '' }} @else checked='true' @endif">
                                ...
                                <td>
                                    <textarea name="verif_2_note" id="verif_2_note" class="form-control" placeholder="Penjelasan">@if($analisKepatuhan && $analisKepatuhan->verif_2_note) {{ $analisKepatuhan != '' ? $analisKepatuhan->verif_2_note : '' }}@else Kriteria Mitra Kemaslahatan memenuhi salah satu bentuk badan hukum/lembaga @endif</textarea>
                                </td>
                            </tr>
                            <tr>
                                <td rowspan="3">3.</td>
                                ...
                                <td>
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" class="custom-control-input" name="verif_3a_value" id="verif_3a_ya" value="3a" @if($analisKepatuhan) {{ $analisKepatuhan->verif_3a_value == '3a' ? 'checked' : '' }} @else checked='true' @endif">
                                ...
                                <td>
                                    <textarea name="verif_3a_note" id="verif_3a_note" class="form-control" placeholder="Penjelasan">@if($analisKepatuhan && $analisKepatuhan->verif_3a_note){{ $analisKepatuhan != '' ? $analisKepatuhan->verif_3a_note : '' }}@else Syarat Administrasi Umum @endif</textarea>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" class="custom-control-input" name="verif_3b_value" id="verif_3b_ya" value="3b" @if($analisKepatuhan) {{ $analisKepatuhan->verif_3b_value == '3b' ? 'checked' : '' }} @else checked='true' @endif">
                                ...
                                <td>
                                    <textarea name="verif_3b_note" id="verif_3b_note" class="form-control" placeholder="Penjelasan">@if($analisKepatuhan && $analisKepatuhan->verif_3b_note){{ $analisKepatuhan != '' ? $analisKepatuhan->verif_3b_note : '' }}@else Syarat Administrasi Umum @endif</textarea>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" class="custom-control-input" name="verif_3c_value" id="verif_3c_ya" value="3c" @if($analisKepatuhan)  {{ $analisKepatuhan->verif_3c_value == '3c' ? 'checked' : '' }} @else checked='true' @endif">
                                ...
                                <td>
                                    <textarea name="verif_3c_note" id="verif_3c_note" class="form-control" placeholder="Penjelasan">@if($analisKepatuhan && $analisKepatuhan->verif_3c_note){{ $analisKepatuhan != '' ? $analisKepatuhan->verif_3c_note : '' }}@else  Surat pernyataan keabsahan dokumen @endif</textarea>
                                </td>
                            </tr>
                            <tr>
                                <td rowspan="4">4.</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" class="custom-control-input" name="verif_4a_value" id="verif_4a_ya" value="4a" @if($analisKepatuhan) {{ $analisKepatuhan->verif_4a_value == '4a' ? 'checked' : '' }} @else checked='true' @endif">
                                ...
                                <td>
                                    <textarea name="verif_4a_note" id="verif_4a_note" class="form-control" placeholder="Penjelasan">@if($analisKepatuhan && $analisKepatuhan->verif_4a_note){{ $analisKepatuhan != '' ?  $analisKepatuhan->verif_4a_note : '' }}@else Rencana Anggaran Biaya (RAB) @endif</textarea>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" class="custom-control-input" name="verif_4b_value" id="verif_4b_ya" value="4b" @if($analisKepatuhan) {{ $analisKepatuhan->verif_4b_value == '4b' ? 'checked' : '' }} @else checked='true' @endif">
                                ...
                                <td>
                                    <textarea name="verif_4b_note" id="verif_4b_note" class="form-control" placeholder="Penjelasan">@if($analisKepatuhan && $analisKepatuhan->verif_4b_note) {{ $analisKepatuhan != '' ?  $analisKepatuhan->verif_4b_note : '' }}@else Gambar rencana desain  @endif</textarea>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" class="custom-control-input" name="verif_4c_value" id="verif_4c_ya" value="4c" @if($analisKepatuhan) {{ $analisKepatuhan->verif_4c_value == '4c' ? ' checked' : '' }} @else checked='true' @endif">
                                ...
                                <td>
                                    <textarea name="verif_4c_note" id="verif_4c_note" class="form-control" placeholder="Penjelasan">@if($analisKepatuhan && $analisKepatuhan->verif_4c_note){{ $analisKepatuhan != '' ?  $analisKepatuhan->verif_4c_note : '' }} @else Foto obyek/lokasi rencana kegiatan @endif</textarea>
                                </td>
                            </tr>
                        </tbody>
                    </table>
	...
	<div class="card-body">
	      <button id="rekomendasi-hukum" class="btn btn-sm btn-primary mx-1 px-2" data-bind='{{ $proposal->trx_proposal_child_id }}' data-status='{{ $proposal->proses_st }}'>Rekomendasikan</button>
              <button id="rekomendasi-hukum-back" class="btn btn-sm btn-danger mx-1 px-2" data-bind='{{ $proposal->trx_proposal_child_id }}'>Kembalikan</button>
	</div>
    </div>
    @else 
    <div class="card">
...
<script>
	...
	$(document).on('click', '#rekomendasi-hukum-back',function(){
       ...
       $('#form-penilaian-mitra').submit(function(e){
            if (e.isDefaultPrevented()) {
			//--Handle the invalid form
            } else {
				e.preventDefault();
                var record  = $('#form-penilaian-mitra').serialize();

                swal({
                    title               : 'Simpan Penilaian Mitra Kemaslahatan?',
                    type                : "question",
                    showCancelButton    : true,
                    confirmButtonColor  : "#00a65a",
                    confirmButtonText   : "OK",
		...
		if(result.value){
                        ...
                        $.ajax({
                            'type': "PUT",
                            'url' : baseUrl+'/item-penilaian/simpan-penilaia-mitra/{{ $proposal->trx_proposal_child_id }}',
                            'data': record,
                            'dataType' : 'JSON',
                            'success': function(response){
                                if(response["status"] == 'ok') {
	...
	$('body').on('click','.simpan-note-penilaian', function(e){
		...
		var data_id = $(this).attr('data-id')
	        console.log(data_id)
                var record  = $('#note-penilaian'+data_id).serialize();
		console.log(record)
                swal({
