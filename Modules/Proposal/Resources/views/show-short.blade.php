                    ...
                    @endif
                            ...
                            <ul class="nav nav-tabs nav-tabs-solid nav-justified rounded border-0 mt-5">
                                ...
                                <li class="nav-item"><a href="#tab-data-rekomendasi" class="nav-link rounded-left" data-toggle="tab"><i class="icon-floppy-disk d-block mb-1 mt-1"></i>Rekomendasi Pejabat Berwenang</a></li>
                                    ...
                                    @elseif (isRoleUser(['mitra', 'bidhk', 'bindmr']) && in_array($proposal->proses_st, ['PROSES_AMK']))
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="row">
                                                <div class="col-md-6">
                                    ...
                                    @if((isJabatanUser(1) && $proposal->proses_st == 'PROSES_AMK') )
                                    <ul class="nav nav-tabs nav-tabs-solid nav-justified rounded border-0 mt-5">
...
<script>
    ...
    $('#btnAddFoto').on('click', function() {
        var body = '<div class="form-group mt-3" id="formFoto-0">'
        body += '<div class="row">'
        body += '<div class="col-md-6">'
        body += '<input type="file" name="photo[]" id="photox" autocomplete="off" class="form-control">'
        body += '</div>'
        body += '</div>'
        body += '</div>'
	$(".form-add-foto").append(body);
    });
