        ...
        <div class="halaman">	
            <center style="margin-bottom:0">
                ...
                <p style="margin-top: 30px;text-align: center;letter-spacing: 0px;line-height: 1.5rem;">
                    ...
                    BADAN PENGELOLA KEUANGAN HAJI <br>
                    NOMOR 022/BPKH.00/02/2022<br>
                    TENTANG <br>
                    KEGIATAN KEMASLAHATAN UMAT ISLAM DALAM BENTUK <br />{{ strtoupper($data->judul_proposal) }} MELALUI {{ strtoupper($data->mitra_kemaslahatan_nm) }} <br><br>
			...
			<table class="tabel-sk" width="100%" style="margin-top: 30px;vertical-align: top;text-align: justify;letter-spacing: 0px;line-height: 1.5rem;">
				<tr>
					...
					<td style="vertical-align: top" width="75%" style="font-size: 11pt;font-family:Arial, Helvetica, sans-serif">
                        bahwa untuk menunjang kegiatan sosial keagamaan umat 
Islam yang merupakan bagian dari program prioritas 
kegiatan kemaslahatan Badan Pengelola Keuangan Haji 
diperlukan dukungan sarana dan prasarana kegiatan 
sosial keagamaan;                    </td>
                </tr>
				<tr>
				...
				<tr>
					...
					<td style="vertical-align: top" width="75%" style="font-size: 11pt;font-family:Arial, Helvetica, sans-serif">
						bahwa Badan Pelaksana menyetujui proposal kegiatan kemaslahatan dalam bentuk {{ strtoupper($data->judul_proposal) }} melalui {{ strtoupper($data->mitra_kemaslahatan_nm) }} dalam Rapat Badan Pelaksana pada tanggal {{ date('d M Y', strtotime($pelaksanaanPenilaian->penilaian_datetime)) }};
                    </td>
                </tr>
				<tr>
		...
		<div class="halaman">	
			<table class="tabel-sk" width="100%" style="margin-top: 30px;vertical-align: top;text-align: justify;letter-spacing: 0px;line-height: 1.5rem;">
				...
				<tr>
					...
					<td style="vertical-align: top" width="75%" style="font-size: 11pt;font-family:Arial, Helvetica, sans-serif">
                        Peraturan Badan Pengelola Keuangan Haji Nomor 7 Tahun 
2018 tentang Penetapan Prioritas Kegiatan Kemaslahatan 
Dan Penggunaan Nilai Manfaat Dana Abadi Umat (Berita 
Negara Republik Indonesia Tahun 2018 Nomor 1301) 
sebagaimana telah beberapa kali diubah terakhir dengan 
Peraturan Badan Pengelola Keuangan Haji Nomor 4 Tahun 
2020 tentang Perubahan Kedua atas Peraturan Badan 
Pengelola Keuangan Haji Nomor 7 Tahun 2018 tentang 
Penetapan Prioritas Kegiatan Kemaslahatan Dan 
Penggunaan Nilai Manfaat Dana Abadi Umat (Berita 
Negara Republik Indonesia Tahun 2020 Nomor 409);                     </td>
                </tr>
				<tr>
					<td style="vertical-align: top" width="5%">5.</td>
					<td style="vertical-align: top" width="75%" style="font-size: 11pt;font-family:Arial, Helvetica, sans-serif">
						Peraturan Kepala Badan Pelaksana Badan Pengelola 
Keuangan Haji Nomor 3 Tahun 2020 tentang Pedoman 
Teknis Kegiatan Kemaslahatan sebagaimana telah 
beberapa kali diubah terakhir dengan Peraturan Kepala 
Badan Pelaksana Badan Pengelola Keuangan Haji Nomor 
11 Tahun 2021 tentang Perubahan Kelima atas Peraturan 
Kepala Badan Pelaksana Badan Pengelola Keuangan Haji 
Nomor 3 Tahun 2020 tentang Pedoman Teknis Kegiatan 
Kemaslahatan;                     </td>
                </tr>
			</table>
		</div>
		...
		<div class="halaman">
			...
			<table class="tabel-sk" width="100%" style="margin-top: 30px;vertical-align: top;text-align: justify;letter-spacing: 0px;line-height: 1.5rem;">
				...
				<tr>
					...
					<td style="vertical-align: top" width="5%">:</td>
					<td style="vertical-align: top" width="75%" style="font-size: 11pt;font-family:Arial, Helvetica, sans-serif">
						Selain pengeluaran pelaksanaan Kegiatan Kemaslahatan sebagaimana dimaksud dalam Diktum KESATU, segala biaya yang timbul akibat Keputusan ini dibebankan kepada Rencana Kerja dan Anggaran Bidang Kemaslahatan Tahun 2022.
                    </td>
                </tr>
				<tr>
				...
				<table width="100%" style="font-size: 12" style="border: none">
					...
					<tr>
						...
						<td style="vertical-align: top;">
								...
								pada tanggal <?php echo date('d M Y', strtotime($proposalMitraUpdated->updated_at)) ?><br><br>
