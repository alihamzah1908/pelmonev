...
<div id="accordion-default">
    ...
    <div class="card">
        ...
        <div class="card-body">                            
			...
			<div class="col-md-12">
                            <div class="form-group form-group-float">
                                <label class="form-group-float-label is-visible">Dasar Hukum<span class="text-danger">*</span></label>
                                <textarea name="dasar_hukum" id="analisa_hukum" class="form-control summernote" required="required">{{ $analisisResiko? $analisisResiko->dasar_hukum : '' }}</textarea>
                            </div>
                        </div>
			<div class="col-md-12">
                            <div class="form-group form-group-float">
                                <label class="form-group-float-label is-visible">Mitra Kemaslahatan<span class="text-danger">*</span></label>
                                <textarea name="mitra_kemaslahatan" id="analisa_hukum" class="form-control summernote" required="required">{{ $analisisResiko? $analisisResiko->mitra_kemaslahatan : $mitra->mitra_kemaslahatan_nm }}</textarea>
                            </div>
                        </div>
                        <hr>
