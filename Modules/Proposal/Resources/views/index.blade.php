...
<div class="card">
	...
	<div class="card-body">
		...
		<div id="frame-tabel">
            ...
            @if (isRoleUser(['regas', 'bidhk', 'bidmr']))
            <h3>Kajian dan Analisa</h3>
            <div class="table-responsive">
		<table class="table datatable-pagination" id="tabel-data-mitra" width="100%">
		    <thead>
			<tr>
			    <th width="0%">No</th>
			    <th width="10%">Kode Proposal</th>
            ...
            @endif
	    @if (isRoleUser(['regas']) && isJabatanUser(4))
            <h3>Rapat BP</h3>
            <div class="table-responsive">
		<table class="table datatable-pagination" id="tabel-data-bp" width="100%">
		    <thead>
			<tr>
			    <th width="0%">No</th>
			    <th width="10%">Kode Proposal</th>
	    ...
	    <h3>Rapat KEK</h3>
            <div class="table-responsive">
		<table class="table datatable-pagination" id="tabel-data-kek" width="100%">
		    <thead>
			<tr>
			    <th width="0%">No</th>
			    <th width="10%">Kode Proposal</th>
                    ...
                    <div class="modal-body">
                        <form class="form-validate-jquery" id="form-input-proposal" action="#">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group form-group-float">
                                        <label class="form-group-float-label is-visible">Kabupaten/Kota</label>
...
<script>
    ...
    $(document).ready(function(){
        ...
        tabelDataMitra = $('#tabel-data-mitra').DataTable({
            language: {
                paginate: {'next': $('html').attr('dir') == 'rtl' ? 'Next &larr;' : 'Next &rarr;', 'previous': $('html').attr('dir') == 'rtl' ? '&rarr; Prev' : '&larr; Prev'}
            },
            pagingType: "simple",
	...
	tabelDataBp = $('#tabel-data-bp').DataTable({
            language: {
                paginate: {'next': $('html').attr('dir') == 'rtl' ? 'Next &larr;' : 'Next &rarr;', 'previous': $('html').attr('dir') == 'rtl' ? '&rarr; Prev' : '&larr; Prev'}
            },
            pagingType: "simple",
            ...
            order		: [[12,'desc']], 
            ajax		: {
                url: baseUrl + '/data/rapat',
                type: "GET",
                data: function(data){
                    data._token     = $('meta[name="csrf-token"]').attr('content');
                    data.judul      = $('input[name=search_param]').val();
                    data.proses     = $('select[name=proses_st_param]').val();
		    data.rapat 	    = 'PROSES_TRBP'
                },
            },
            dom : 'tpi',
            columns: [
	...
	tabelDataKek = $('#tabel-data-kek').DataTable({
            language: {
                paginate: {'next': $('html').attr('dir') == 'rtl' ? 'Next &larr;' : 'Next &rarr;', 'previous': $('html').attr('dir') == 'rtl' ? '&rarr; Prev' : '&larr; Prev'}
            },
            pagingType: "simple",
