...
class ItemPenilaianController extends Controller
{
    ...
    function getData(Request $request){
        ...
        $data = DB::select("SELECT trx_proposal_layak_teknis_id, trx_proposal_id, 
                ...
                AND com_code.code_group IN ('LT_01','LT_02','LT_03','LT_04') LIMIT 30");
    ...
    function update(Request $request, $id){
	    ...
	    $value_yes = PublicTrxProposalLayakTeknis::select('layak_teknis_value')
		->where('trx_proposal_id', $layak_teknis->trx_proposal_id)
		->where('layak_teknis_value', '1')
		->get();
	    $value_no = PublicTrxProposalLayakTeknis::select('layak_teknis_value')
		->where('trx_proposal_id', $layak_teknis->trx_proposal_id)
		->where('layak_teknis_value', '0')
		->get();

            return response()->json(['status' => 'ok','yes' => $value_yes->count(), 'no' => $value_no->count()],200); 
