                ...
                <div class="sidebar-user-material-body">
                    <div class="card-body text-center">
                        <a href="{{ url('/profile') }}">
							...
							@if (Auth::user()->image == NULL)                                     
                                <img class="img-fluid rounded-circle shadow-1 mb-3" src="{{ asset('/images/profile.jpeg') }}" width="50" height="50" alt="" style="background:#fff">
                            @else
                                <img class="img-fluid rounded-circle shadow-1 mb-3" src="{{ asset('/storage/file/image/') }}/{{ Auth::user()->image }}" width="50" height="50" style="background: #fff" alt="" style="background:#fff">
                            @endif
                        </a>
                        <h6 class="mb-0 text-white text-shadow-dark">{{ Auth::user()->user_nm }}</h6>
                        <span class="font-size-sm text-white text-shadow-dark">{{ Auth::user()->user_nm }}</span>
                    </div>
