				...
				<div class="row">
					...
					<div class="col-md-4">
						<div class="form-group form-group-float">
							...
							<select name="code_group" id="code_group" data-placeholder="Pencarian Group" class="form-control form-control-select2 select-search" data-fouc>
                                <option value=""></option>
                                @foreach ($groups as $item)
                                    <option value="{{ $item->code_group}}">{{ $item->code_group}}</option>
                                @endforeach
...
<script>
    ...
    var baseUrl = '{{ url("sistem/configuration/") }}';
    ...
    $(document).ready(function(){
        ...
        $('#reload-table').click(function(){
			...
			//window.location = '/sistem/configuration/';
		});
        ...
        $('#form-data').submit(function(e){
			...
			//--Handle the invalid form
				...
				/* var record=$('#form-data').serialize();
                var url     = '{{ url("/sistem/configuration/") }}';
                var method  = 'POST'; */
