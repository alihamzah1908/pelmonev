...
<!-- Core JS files -->
    ...
    <style>
        .login-cover2 {
            background: url("/images/bg-bpkh.png") no-repeat;
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group form-group-feedback form-group-feedback-left">
                            <input type="password" name="password" class="form-control"
                                   placeholder="{{ __('Password') }}" required="" placeholder=""
                                   aria-invalid="false" />
                            <div class="form-control-feedback">
                        ...
                        <div class="form-group d-flex align-items-center">
                            <div class="form-check mb-0">
                                <label class="form-check-label">
                                    ...
                                    {{ __('Ingat Saya') }} --}}
                                    <a href="https://youtube.com" target="_blank" class="ml-auto">{{ __('Tutorial Penggunaan Aplikasi') }}</a>
                                </label>
                            </div>
                        ...
                        <div class="form-group">
                            <a class="btn btn-success btn-block" href="{{ url('/register') }}">
                                DAFTAR
                            </a>
                        </div>
...
<footer class="footer">
    <div class="container text-center">
        <img src="{{ asset('/images/logo-bpkh-s.png') }}">
